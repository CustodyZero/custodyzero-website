...
Hardware may be returned within **30 days of delivery** for a full refund, provided:

- The hardware is in its original condition with all included accessories and packaging.
- The return is initiated by emailing support@custodyzero.com with your order number.

We will provide a prepaid return shipping label. Once the hardware is received and inspected, we will issue a full refund within 5–10 business days to your original payment method.

### After 30 days — defects and warranty

After the 30-day return window, hardware that fails due to a defect in materials or workmanship within the 12-month warranty period will be repaired or replaced at CustodyZero's option, at no charge.

To initiate a warranty claim, contact support@custodyzero.com with:
- Your order number or proof of purchase.
- A description of the defect.
- Photos or video showing the issue, where applicable.

The warranty does not cover:

- Damage from misuse, drops, liquid exposure, or modifications.
- Normal wear and cosmetic damage that does not affect function.
...
All refunds are returned to the original payment method used at the time of purchase. We cannot issue refunds to a different card or bank account.
